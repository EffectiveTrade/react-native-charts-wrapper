...
public abstract class BarLineChartBase<T extends BarLineScatterCandleBubbleData<? extends
    ...
    protected void init() {
        ...
        // dragTriggerDistance was 3f
        mChartTouchListener = new BarLineChartTouchListener(this, mViewPortHandler.getMatrixTouch(), 2f);
 ...
 */
    ...
    public boolean isFullyZoomedOutX() {
        return mViewPortHandler.isFullyZoomedOutX();
    }

    public boolean isFullyZoomedOutY() {
        return mViewPortHandler.isFullyZoomedOutY();
    }
