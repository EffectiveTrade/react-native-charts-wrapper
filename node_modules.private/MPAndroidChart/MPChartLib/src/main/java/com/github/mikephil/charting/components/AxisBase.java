...
public abstract class AxisBase extends ComponentBase {
    ...
    private boolean mLabelBgEnabled = false;

    /// Background color of the label
    private int mLabelBgColor = Color.LTGRAY;

    /// Padding of the label
    private float mLabelPadding = 2;

    /// Radius of the label
    private float mLabelRadius = 0f;
    ...
    public void setLabelBgEnabled(boolean v) {
        mLabelBgEnabled = v;
    }

    public boolean getLabelBgEnabled() {
        return mLabelBgEnabled;
    }
    ...
    public void setLabelPadding(float v) {
        mLabelPadding = v;
    }
    ...
    public void setLabelRadius(float v) {
        mLabelRadius = v;
    }

    public float getLabelRadius() { return mLabelRadius; }
