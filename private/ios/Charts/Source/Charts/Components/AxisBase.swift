...
open class AxisBase: ComponentBase
{
    ...
    /// flag that indicates the custom label
    @objc open var labelBgEnabled = false

    /// Background color of the label
    @objc open var labelBgColor: NSUIColor? = NSUIColor.systemGray

    /// Padding of the label
    @objc open var labelPadding: CGFloat = 2.0

    /// Radius of the label
    @objc open var labelRadius: CGFloat = 0.0
